const AboutSectionPreview = ({ entry, getAsset, widgetFor }) => {
                    ...
                    <div class="col-lg-12">
                        <div class="about_content">
                            ...
                            <div class="about_content-inner">
                                ...
                                <div>
                                    <a class="btn btn-primary mr-3 btn-zoom">{ data.button1Name }</a>
                                    <a class="btn btn-outline-primary btn-zoom">{ data.button2Name }</a>
                                </div>
                            </div>
                        </div>
                    </div>
