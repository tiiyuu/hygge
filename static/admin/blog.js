        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-10 col-md-12 offset-lg-1 offset-md-0 text-center">
              <h3 class="breadCrumb__title">{ entry.getIn(["data", "title"])}</h3>
              <nav aria-label="breadcrumb" class="d-flex justify-content-center">
                <ol class="breadcrumb align-items-center">
                  <li class="breadcrumb-item"><a href={ .Site.BaseURL }>Home</a></li>
                  <li class="breadcrumb-item"><a href={ .Site.Params.blogPageURL }>All Post</a></li>
                  <li class="breadcrumb-item active" aria-current="page">{ entry.getIn(["data", "title"])}</li>
                </ol>
              </nav>
            </div>
          </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="singleBlog__feature">
                        { postImage && <img src={ postImage } alt="feature-image" /> }
                    </div>
                </div>
            </div>
            <div class="row mt-5">
