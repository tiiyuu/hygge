        ...
        <section class="section service" id="service">
            <div class="service__background">
                <svg viewBox="0 0 1283 1126">
                    <path fill={ data.bubbleColor } d="M100 0h1183v1126l-1183-80A100 100 0 010 946V100A100 100 0 01100 0z"
                        data-name="Path 1369" />
                </svg>
            </div>
            <div class="service__background_shape">
                <svg viewBox="0 0 550 550">
                    ...
                    <g data-name="blob-shape (3)">
                        <path class="blob" fill={ data.bubble2Color }
            ...
            <div class="service__background_pattern">
                <img src={`/${data.bgImage}`} alt="background-pattern" />
            </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="service__slider">
                            { widgetsFor('services').map((service) => (
                                    ...
                                    <div class="service__slider_item-icon">
                                        <div class="icon-background">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="122.457" height="109.702"
                                                ...
                                                <path fill={service.get('data').toJS().fill}
                                        ...
                                        <div class="icon">
                                            <img src={`/${service.get('data').toJS().image}`} alt="ui-ux" />
                                        </div>
                                    </div>
                                    <div class="mt-5">
                                        { service.get('widgets').toJS().content }
                                    </div>
                                </div>
                            )) }
                        </div>
...
CMS.registerPreviewTemplate('service', ServiceSectionPreview)